...
import './css/style.css'; // Adjust the path as needed for your CSS
        ...
        <div className="row">
          ...
          <div className="col-lg-4 mb-5">
            <div className="card border-0 bg-light shadow-sm pb-2">
              <img className="card-img-top mb-2" src="./Image/class-1.jpg" alt="Drawing Class" />
          ...
          <div className="col-lg-4 mb-5">
            <div className="card border-0 bg-light shadow-sm pb-2">
              <img className="card-img-top mb-2" src="./Image/class-2.jpg" alt="Language Learning" />
              <div className="card-body text-center">
          ...
          <div className="col-lg-4 mb-5">
            <div className="card border-0 bg-light shadow-sm pb-2">
              <img className="card-img-top mb-2" src="./Image/class-3.jpg" alt="Basic Science" />
              <div className="card-body text-center">
